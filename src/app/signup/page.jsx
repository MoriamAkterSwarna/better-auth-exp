...
export default function SignupPage() {
    return (
        <main className="relative grid min-h-dvh place-items-center overflow-hidden bg-[radial-gradient(circle_at_15%_20%,#ffd8a8_0%,rgba(255,216,168,0)_40%),radial-gradient(circle_at_85%_10%,#b2f2bb_0%,rgba(178,242,187,0)_38%),linear-gradient(135deg,#f8f9fa_0%,#f1f3f5_45%,#fff9db_100%)] p-6">
            ...
            <section className="grid w-full max-w-[66rem] overflow-hidden rounded-3xl bg-white/80 shadow-[0_24px_60px_rgba(73,80,87,0.17)] backdrop-blur-sm md:grid-cols-2">
                ...
                <article className="bg-white/90 p-7 sm:p-10 lg:p-12">
                    ...
                    <form action={signUpAction} className="grid gap-[0.65rem]">
                        ...
                        <button
                            className="mt-3 cursor-pointer rounded-xl border-none bg-gradient-to-br from-[#e67700] to-[#d9480f] px-4 py-[0.92rem] text-[0.98rem] font-bold text-white transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(217,72,15,0.34)] hover:saturate-110"
                            type="submit"
                        >
                            Create account
                        </button>
            ...
            <div className="mt-10 flex w-full max-w-[66rem] items-center justify-center gap-3">
                <GoogleSignInButton />
                    ...
                    <p className="mt-4 text-[0.93rem] text-[#52606d]">
                        ...
                        <Link className="font-bold text-[#c2410c] hover:underline" href="/signin">
                            Sign in
                        </Link>
                    </p>
                </article>
