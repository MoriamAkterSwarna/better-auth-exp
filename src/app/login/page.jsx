			...
			<section className="grid w-full max-w-5xl overflow-hidden rounded-3xl bg-white/80 shadow-[0_24px_60px_rgba(30,41,59,0.18)] backdrop-blur-sm md:grid-cols-2">
				...
				<article className="order-1 bg-white/90 p-7 md:order-2 sm:p-10 lg:p-12">
					...
					<form onSubmit={handleSubmit} className="grid gap-[0.65rem]">
						...
						<button
							className="mt-3 cursor-pointer rounded-xl border-none bg-linear-to-br from-indigo-600 to-cyan-600 px-4 py-[0.92rem] text-[0.98rem] font-bold text-white transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(79,70,229,0.34)] hover:saturate-110 disabled:cursor-not-allowed disabled:opacity-70"
							type="submit"
							disabled={isPending}
						>
					...
					<p className="mt-4 text-[0.93rem] text-slate-600">
						New here?{" "}
						<Link className="font-bold text-indigo-700 hover:underline" href="/register">
							Create account
						</Link>
					</p>
				</article>
